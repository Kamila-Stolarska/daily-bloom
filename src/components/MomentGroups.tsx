// Dwie grupy dni wg tagów (sekcja 11 specyfikacji Insights): tylko dobre,
// tylko trudne. Karty w formie poziomego wykresu słupkowego (siatka + oś skali
// 1–5), kolory te same co znaczniki "coś dobrego/trudnego" na wykresie trendu.
// Bez sugerowania, że tag sam w sobie powoduje zmianę wyników.
